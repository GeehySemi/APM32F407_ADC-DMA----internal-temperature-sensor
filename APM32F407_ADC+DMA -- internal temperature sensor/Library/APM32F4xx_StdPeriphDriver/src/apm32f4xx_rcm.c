 ...
 *                        This parameter can be one of the following values:
 *                        @arg RCM_MCO2_SEL_SYSCLK
 *                        @arg RCM_MCO2_SEL_PLL2CLK
 *                        @arg RCM_MCO2_SEL_HSECLK
 *                        @arg RCM_MCO2_SEL_PLLCLK
 *
 ...
 *                       This parameter can be any combination of the following values:
 *                       @arg RCM_AHB2_PERIPH_DCI
 *                       @arg RCM_AHB2_PERIPH_FPU
 *                       @arg RCM_AHB2_PERIPH_BN
 *                       @arg RCM_AHB2_PERIPH_SM
 *                       @arg RCM_AHB2_PERIPH_CRYP
 *                       @arg RCM_AHB2_PERIPH_HASH
 *                       @arg RCM_AHB2_PERIPH_RNG
 *                       @arg RCM_AHB2_PERIPH_OTG_FS
 *
 * @retval    None
 */
