 ...
 *                This parameter can be one of the following values:
 *                  @arg DMA_INT_FEIFLGx:  channelx transfer complete flag
 *                  @arg DMA_INT_HTIFLGx:  channelx half transfer complete flag
 *                  @arg DMA_INT_TEIFLGx:  channelx transfer error flag
 *                  @arg DMA_INT_DMEIFLGx: channelx direct mode error flag
 *                  @arg DMA_INT_FEIFLGx:  channelx FIFO error flag
 *                 Where x can be 0 to 7 to select the DMA channel.
 *
 * @retval    None.
 */
 ...
 *                This parameter can be any combination of the following values:
 *                  @arg DMA_INT_TCIFLGx:  channelx transfer complete flag
 *                  @arg DMA_INT_HTIFLGx:  channelx half transfer complete flag
 *                  @arg DMA_INT_TEIFLGx:  channelx transfer error flag
 *                  @arg DMA_INT_DMEIFLGx: channelx direct mode error flag
 *                  @arg DMA_INT_FEIFLGx:  channelx FIFO error flag
