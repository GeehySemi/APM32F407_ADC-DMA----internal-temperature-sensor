...
typedef enum
{
    TMR_COUNTER_MODE_UP              = 0x00,
    TMR_COUNTER_MODE_DOWN            = 0x01,
    TMR_COUNTER_MODE_CENTER_ALIGNED1 = 0x10,
    TMR_COUNTER_MODE_CENTER_ALIGNED2 = 0x20,
    TMR_COUNTER_MODE_CENTER_ALIGNED3 = 0x30
} TMR_COUNTER_MODE_T;
...
typedef enum
{
    TMR2_TMR8_TRGO     = 0x0000,
    TMR2_PTP_TRG       = 0x0400,
    TMR2_OTG_FSUSB_SOF = 0x0800,
    TMR2_OTG_HSUSB_SOF = 0x0C00,
    TMR5_GPIO          = 0x0000,
    TMR5_LSI           = 0x0040,
    TMR5_LSE           = 0x0080,
    TMR5_RTC           = 0x00C0,
