...
/** @defgroup APM32F407_MINI_Private_Variables
  * @{
  */
...
const GPIO_PIN_SOURCE_T COM_TX_PIN_SOURCE[COMn] = {MINI_COM1_TX_PIN_SOURCE, MINI_COM2_TX_PIN_SOURCE};

const GPIO_PIN_SOURCE_T COM_RX_PIN_SOURCE[COMn] = {MINI_COM1_RX_PIN_SOURCE, MINI_COM2_RX_PIN_SOURCE};

const GPIO_AF_T COM_GPIO_AF[COMn] = {MINI_COM1_GPIO_AF, MINI_COM2_GPIO_AF};
...
/** @defgroup APM32F407_MINI_Private_Functions
  * @{
  */
